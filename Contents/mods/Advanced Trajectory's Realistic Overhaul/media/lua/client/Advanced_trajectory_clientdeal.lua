...
local function Advanced_trajectory_OnServerCommand(module, command, arguments)
	...
	if module == "ATY_shotplayer" then
		...
		local playershot = getPlayerByOnlineID(playershotOnlineID)  --Playershot
        local attackerOnlineID = arguments[2]                       --attacker:getOnlineID()  
		local attacker = getPlayerByOnlineID(attackerOnlineID)      --attacker
        ...
        --damagePlayershotPVP(player, playerShot, damage, baseGunDmg, headShotDmg, bodyShotDmg, footShotDmg, playerOnlineID, playershotOnlineID)
        print("*-----------------------------------------------------------------------------*")
...
--------------------------------
function damagePlayershotPVP(player, playerShot, damage, baseGunDmg, headShotDmg, bodyShotDmg, footShotDmg, playerOnlineID, playershotOnlineID)
